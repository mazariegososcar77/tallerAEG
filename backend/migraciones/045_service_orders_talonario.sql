...
-- work_order_items.
-- OJO: las columnas cortas son VARCHAR(100) a proposito. Un VARCHAR de hasta 63 caracteres
-- cuenta completo contra el limite de 8126 bytes por fila de InnoDB; de 64 en adelante se
-- guarda aparte y casi no cuenta. Con VARCHAR(30)/(60) la tabla se pasaba del limite.
-- Requiere 028_service_order_field_report.sql aplicada antes (usa visit_date).
-- Ejecutar despues de 044_work_orders_talonario.sql
-- =====================================================================

ALTER TABLE service_orders
  ADD COLUMN code                      VARCHAR(100)   NULL AFTER number,
  ...
  ADD COLUMN amperage                  VARCHAR(100)   NULL,
  ADD COLUMN rpm                       INT           NULL,
  ADD COLUMN hp                        DECIMAL(8,3)  NULL,
  ADD COLUMN frame                     VARCHAR(100)   NULL,
  ADD COLUMN pump_brand                VARCHAR(120)  NULL,
  ADD COLUMN pump_impeller             VARCHAR(100)   NULL,
  ADD COLUMN pump_bm                   VARCHAR(100)   NULL,
  ADD COLUMN pump_seal_size            VARCHAR(100)   NULL,
  ADD COLUMN pump_seal_type            ENUM('viton','nitrilo','conico') NULL,
  ADD COLUMN physical_parts            JSON          NULL,
  ADD COLUMN retainers_count           VARCHAR(100)   NULL,
  ADD COLUMN shaft_rectify_mm          VARCHAR(100)   NULL,
  ADD COLUMN bearings_count            VARCHAR(100)   NULL,
  ADD COLUMN bearings_mm               VARCHAR(100)   NULL,
  ADD COLUMN bearings_mm_2             VARCHAR(100)   NULL,
  ADD COLUMN seal_liner_mm             VARCHAR(100)   NULL,
  ADD COLUMN front_cover_mm            VARCHAR(100)   NULL,
  ADD COLUMN rear_cover_mm             VARCHAR(100)   NULL,
  ADD COLUMN fan_hole_mm               VARCHAR(100)   NULL,
  ADD COLUMN lathe_kw                  VARCHAR(100)   NULL,
  ADD COLUMN lathe_hp                  VARCHAR(100)   NULL,
  ...
  ADD COLUMN dte_number                VARCHAR(100)   NULL,
  ADD COLUMN oc_number                 VARCHAR(100)   NULL,
  ...
  ADD COLUMN whatsapp_number           VARCHAR(100)   NULL,
